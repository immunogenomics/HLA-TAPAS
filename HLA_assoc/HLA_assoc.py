...
from HLA_assoc.src.reverse_map import reverse_map
from HLA_assoc.src.unATtrickBGL import unATtrickBGL
...
class HLA_assoc(object):
    ...
    def __init__(self, _MAIN_MENU, _out, _dependency='./dependency', **kwargs):
        ...
        if _MAIN_MENU == 'LOGISTIC':
            ...
            #               .format(self.fam))
            #         sys.exit()
            # => Checking *.fam file has been deprecated because VCF file is mainly used in HLA_assoc.
    ...
    def Omnibus_Test(self, _out, _pop, _bgl_phased, _fam, _bim, _pheno, _sex, _pcs,
                     ...
                     _exhaustive_max_aa=2,
                     f_exhaustive_no_filter=False,
                     _p_script='HLA_assoc/src/run_omnibus_test.R'):
